...
sim.loadSnake("data\snake.veg", timestep = 0.001, dampingMassCoef = 1., dampingStiffnessCoef = 1., gravity = 10., muscleStiffnessCoef = 100., basePosition = np.array([0., 1., 0.]), baseOrientation = np.array([0., 0., 0.]))
