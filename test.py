...
sim.loadSnake("data\snake.veg", timestep = 0.01, dampingMassCoef = 0., dampingStiffnessCoef = 0.01, gravity = 10., muscleStiffnessCoef = 10000., basePosition = np.array([0., 0.1, 0.]), baseOrientation = np.array([0., 0., 0.]))
sim.setGoal(1., 0., 1.)
